...
class TriageAISummary(BaseModel):
    resumo_curto: str = Field(..., description="Resumo em 2-4 linhas para o/a médico/a.")
    ...
    perguntas_para_consulta: List[str] = Field(default_factory=list, description="Perguntas objetivas para o/a médico/a.")
